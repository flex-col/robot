 ...
 */
open class TextMsgModel(var data: CoreEntity) : ViewModel() {
    ...
    class DataPresenterImpl : ViewHolderPresenter {
        ...
        override fun onBind(holder: BaseViewHolder, entity: ViewModel) {
            ...
            if (holder is DataHolder && entity is TextMsgModel) {
                ...
                GlideUtils.displayCircleHeader(holder.fresco_avatar, App.getUser()!!.iconurl)
            }
    ...
    companion object {
        ...
        const val viewTypeId = R.layout.item_type_chat_txt
